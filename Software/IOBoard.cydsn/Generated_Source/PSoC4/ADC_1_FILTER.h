...
*******************************************************************************/
    ...
    #define ADC_1_CFG0_FILTER_IDEAL_BIQUAD_NUM0      (0.0386680937506803)
    #define ADC_1_CFG0_FILTER_IDEAL_BIQUAD_NUM1      (-0.0735510850685928)
    #define ADC_1_CFG0_FILTER_IDEAL_BIQUAD_NUM2      (0.0386680937506803)
    #define ADC_1_CFG0_FILTER_IDEAL_BIQUAD_DEN0      (0.918186268427475)
    #define ADC_1_CFG0_FILTER_IDEAL_BIQUAD_DEN1      (-1.91440116599471)
    #define ADC_1_CFG0_FILTER_IDEAL_BIQUAD_DEN2      (1)

    #define ADC_1_CFG0_FILTER_UAB_BIQUAD_NUM0        (0.0327868852459016)
    #define ADC_1_CFG0_FILTER_UAB_BIQUAD_NUM1        (-0.0619469026548673)
    #define ADC_1_CFG0_FILTER_UAB_BIQUAD_NUM2        (0.0327868852459016)
    #define ADC_1_CFG0_FILTER_UAB_BIQUAD_DEN0        (0.918032786885246)
    #define ADC_1_CFG0_FILTER_UAB_BIQUAD_DEN1        (-1.91440591904831)
