/*******************************************************************************
* File Name: VDAC_2_OUTBUFFER_PM.c
* Version 1.20
*
* Description:
...
#if(!VDAC_2_OUTBUFFER_CHECK_DEEPSLEEP_SUPPORT)
    static VDAC_2_OUTBUFFER_BACKUP_STRUCT VDAC_2_OUTBUFFER_backup =
    {
        0u, /* enableState */
    };
#endif /* (VDAC_2_OUTBUFFER_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: VDAC_2_OUTBUFFER_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: VDAC_2_OUTBUFFER_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
/*******************************************************************************
* Function Name: VDAC_2_OUTBUFFER_Sleep
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  VDAC_2_OUTBUFFER_backup: The structure field 'enableState' is modified
...
void VDAC_2_OUTBUFFER_Sleep(void)
{
    ...
    {
        VDAC_2_OUTBUFFER_backup.enableState = 1u;
        VDAC_2_OUTBUFFER_Stop();
    }
    else /* The component is disabled */
    {
        VDAC_2_OUTBUFFER_backup.enableState = 0u;
    }
#endif /* (VDAC_2_OUTBUFFER_CHECK_DEEPSLEEP_SUPPORT) */
}
...
/*******************************************************************************
* Function Name: VDAC_2_OUTBUFFER_Wakeup
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  VDAC_2_OUTBUFFER_backup: The structure field 'enableState' is used to
...
{
#if(!VDAC_2_OUTBUFFER_CHECK_DEEPSLEEP_SUPPORT)
    if(0u != VDAC_2_OUTBUFFER_backup.enableState)
    {
