...
#define VDAC_1_UAB_MIN(x, y)  ( ((x)>(y))? (y) : (x) )

/*(0x00001fffUL)*/
#define CyUAB_DAC_NEXT_MASK   (VDAC_1_UAB_SIGN_VAL_MASK | VDAC_1_UAB_CA_VAL_MASK | VDAC_1_UAB_CB_VAL_MASK)
#define CyUAB_DAC_NEXT_SHIFT  (VDAC_1_UAB_CB_VAL_SHIFT)
    
/*(0x00000fffUL)*/
#define CyUAB_CF_NEXT_MASK    (VDAC_1_UAB_CF_VAL_MASK | VDAC_1_UAB_CC_VAL_MASK)
...
#define CyUAB_SRAM_OFFSET  ( ((uint32)VDAC_1_UAB_SRAM0_PTR) - ((uint32)VDAC_1_UAB_BASE_ADDR) )
