...
/* CySysClkWriteImoFreq() - implementation definitions */
    ...
    #define CY_SYS_CLK_IMO_TRIM4_USB_GAIN               (( uint32 ) 8u)
        ...
        #define CY_SFLASH_M0_SMR_3_MASK                 (( uint32 )0x3Fu)
    #endif /* (CY_IP_IMO_TRIMMABLE_BY_USB) */
...
#define CY_SYS_CLK_SELECT_PTR               ( (reg32 *) CYREG_CLK_SELECT)
    ...
    #define CY_SFLASH_M0_SMR_3_REG                  (*(reg8 *) 0x0FFFF300u)
    #define CY_SFLASH_M0_SMR_3_PTR                  ( (reg8 *) 0x0FFFF300u)
...
*******************************************************************************/
        ...
        #define CY_SYS_ECO_CLK_SELECT_REG       (*(reg32 *) CYREG_EXCO_ECO_CONFIG)
        #define CY_SYS_ECO_CLK_SELECT_PTR       ( (reg32 *) CYREG_EXCO_ECO_CONFIG)
        ...
        #define CY_SYS_CLK_ECO_TRIM0_PRT        ( (reg32 *) CYREG_EXCO_ECO_TRIM0)

        /* ECO Trim1 Register */
        #define CY_SYS_CLK_ECO_TRIM1_REG        (*(reg32 *) CYREG_EXCO_ECO_TRIM1)
        #define CY_SYS_CLK_ECO_TRIM1_PRT        ( (reg32 *) CYREG_EXCO_ECO_TRIM1)
