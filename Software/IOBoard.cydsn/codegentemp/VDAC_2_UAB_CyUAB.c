...
* @endinternal
*
* @param uabSram starting address of UAB half waveform SRAM; ie VDAC_2_UAB_SRAM1_PTR
* @param pattern clocking in LSbit to MSbit ordering for step 0 to step 15.
* When the @p modbitPattern is high, the
* modbit waveform (chosen by VDAC_2_UAB_SetModbitSource()) is used as
