// ======================================================================
// IOBoard.v generated from TopDesign.cysch
// 10/22/2017 at 19:28
...
module Scan_ADC_v2_0_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("c59db613-4f36-4240-9fd1-6497221364b3/77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
// UABPRIM_v1_10(AGND_PTS=false, AGND_PWR=0, AGND_TIED=false, ALIGN_MODE=0, CA_BOOST=1, CA_VAL=0, CB_64=false, CB_BOOST=1, CB_GND=true, CB_VAL=0, CC_BOOST=0, CC_GND=false, CC_VAL=0, CC_VAL_UPDATE=false, CF_BOOST=1, CF_VAL=31, CF_VAL_UPDATE=true, CMP_DSI_LEVEL=0, CMP_EDGE=0, CMP_FF=0, CMP_PWR=0, COMP_MASK=false, DAC_MODE=2, DAC_MODE_EN=true, EARLY_PO=true, EARLY_PS=true, FRC_SIGN_BIT=false, LAST_STEP=3, MODBIT0_SRC_SEL=0, MODBIT1_SRC_SEL=0, OA_PWR=7, PUMP_WAVE=1, REF_PTS=false, REF_PWR=0, REF_TIED=false, SIGN_VAL=false, STARTUP_DELAY=0, STRB_RST_EN=0, STRB_RST_SEL=0, STROBE_RST=5, STROBE_SW=15, SUBSAMPLE=0, SUBSAMPLE_INIT=0, SUM_BOOST=1, SW_AA=0, SW_AA_1=0, SW_AG_MODBIT=0, SW_AP=0, SW_AQ=0, SW_AR_MODBIT=0, SW_AV_MODBIT=10, SW_AX0_MODBIT=0, SW_AX1_MODBIT=0, SW_AX2_MODBIT=0, SW_AX3_MODBIT=0, SW_BB=0, SW_BG_MODBIT=0, SW_BP=0, SW_BQ=0, SW_BR_MODBIT=0, SW_BV_MODBIT=10, SW_BX0_MODBIT=0, SW_BX1_MODBIT=0, SW_BX2_MODBIT=0, SW_BX3_MODBIT=0, SW_CC=0, SW_CG_MODBIT=0, SW_CP=0, SW_CQ=0, SW_CR_MODBIT=0, SW_CV_MODBIT=0, SW_CX0_MODBIT=0, SW_CX1_MODBIT=0, SW_CX2_MODBIT=0, SW_CX3_MODBIT=0, SW_GA_MODBIT=0, SW_GB_MODBIT=0, SW_GC_MODBIT=0, SW_GF=0, SW_GG=1, SW_GT=0, SW_GX0=0, SW_GX1=0, SW_GX2=0, SW_GX3=0, SW_PF=15, SW_PO=3, SW_PS=1, SW_QT=0, SW_RA_MODBIT=0, SW_RB_MODBIT=0, SW_RC_MODBIT=0, SW_RG=0, SW_RT=0, SW_SA=15, SW_SB=15, SW_SC=0, SW_TB=1, SW_TC=0, SW_VA_MODBIT=0, SW_VB_MODBIT=0, SW_VC_MODBIT=0, SW_ZC=0, TRIG_OUT=0, TRIG_SEL=0, TRIGGER_EN=false, UAB_PWR=0, VALID_WAVE=3, VDAC_EMPTY_MASK=false, WAVE_STEP_0=15121, WAVE_STEP_1=11778, WAVE_STEP_10=0, WAVE_STEP_11=0, WAVE_STEP_12=0, WAVE_STEP_13=0, WAVE_STEP_14=0, WAVE_STEP_15=0, WAVE_STEP_2=3590, WAVE_STEP_3=0, WAVE_STEP_4=0, WAVE_STEP_5=0, WAVE_STEP_6=0, WAVE_STEP_7=0, WAVE_STEP_8=0, WAVE_STEP_9=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UABPRIM_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_1:UAB, CY_INSTANCE_SHORT_NAME=UAB, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC_1_UAB, )
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_1:OUTBUFFER, CY_INSTANCE_SHORT_NAME=OUTBUFFER, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC_1_OUTBUFFER, )
...
// UAB_VDAC_v1_10(ClockFrequency=250 kHz, DacGain=1, DacSelect=0, DefaultOutCode=0, DefaultOutVolts=1, ExtFeedback=false, ExtModBit=false, ExtStrobe=false, testParam_NoCTB=false, UserRefClkRate=250, UserRefClkRateEn=false, VagndSource=0, VagndVolts=1.2, VrefSource=0, VrefVolts=1.2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UAB_VDAC_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_1, CY_INSTANCE_SHORT_NAME=VDAC_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC_1, )
module UAB_VDAC_v1_10_3 (
    vref,
    vo,
    vagnd,
    fb,
	...
	cy_connect_v1_0 cy_analog_virtualmux_3_connect(Net_50, Net_63);
	defparam cy_analog_virtualmux_3_connect.sig_width = 1;

	// cy_analog_virtualmux_4 (cy_analog_virtualmux_v1_0)
	cy_connect_v1_0 cy_analog_virtualmux_4_connect(Net_92, Net_63);
	...
	cy_connect_v1_0 cy_analog_virtualmux_5_connect(Net_495, vo);
...
// UABPRIM_v1_10(AGND_PTS=false, AGND_PWR=0, AGND_TIED=false, ALIGN_MODE=0, CA_BOOST=1, CA_VAL=0, CB_64=false, CB_BOOST=1, CB_GND=true, CB_VAL=0, CC_BOOST=0, CC_GND=false, CC_VAL=0, CC_VAL_UPDATE=false, CF_BOOST=1, CF_VAL=31, CF_VAL_UPDATE=true, CMP_DSI_LEVEL=0, CMP_EDGE=0, CMP_FF=0, CMP_PWR=0, COMP_MASK=false, DAC_MODE=2, DAC_MODE_EN=true, EARLY_PO=true, EARLY_PS=true, FRC_SIGN_BIT=false, LAST_STEP=3, MODBIT0_SRC_SEL=0, MODBIT1_SRC_SEL=0, OA_PWR=7, PUMP_WAVE=1, REF_PTS=false, REF_PWR=0, REF_TIED=false, SIGN_VAL=false, STARTUP_DELAY=0, STRB_RST_EN=0, STRB_RST_SEL=0, STROBE_RST=5, STROBE_SW=15, SUBSAMPLE=0, SUBSAMPLE_INIT=0, SUM_BOOST=1, SW_AA=0, SW_AA_1=0, SW_AG_MODBIT=0, SW_AP=0, SW_AQ=0, SW_AR_MODBIT=0, SW_AV_MODBIT=10, SW_AX0_MODBIT=0, SW_AX1_MODBIT=0, SW_AX2_MODBIT=0, SW_AX3_MODBIT=0, SW_BB=0, SW_BG_MODBIT=0, SW_BP=0, SW_BQ=0, SW_BR_MODBIT=0, SW_BV_MODBIT=10, SW_BX0_MODBIT=0, SW_BX1_MODBIT=0, SW_BX2_MODBIT=0, SW_BX3_MODBIT=0, SW_CC=0, SW_CG_MODBIT=0, SW_CP=0, SW_CQ=0, SW_CR_MODBIT=0, SW_CV_MODBIT=0, SW_CX0_MODBIT=0, SW_CX1_MODBIT=0, SW_CX2_MODBIT=0, SW_CX3_MODBIT=0, SW_GA_MODBIT=0, SW_GB_MODBIT=0, SW_GC_MODBIT=0, SW_GF=0, SW_GG=1, SW_GT=0, SW_GX0=0, SW_GX1=0, SW_GX2=0, SW_GX3=0, SW_PF=15, SW_PO=3, SW_PS=1, SW_QT=0, SW_RA_MODBIT=0, SW_RB_MODBIT=0, SW_RC_MODBIT=0, SW_RG=0, SW_RT=0, SW_SA=15, SW_SB=15, SW_SC=0, SW_TB=1, SW_TC=0, SW_VA_MODBIT=0, SW_VB_MODBIT=0, SW_VC_MODBIT=0, SW_ZC=0, TRIG_OUT=0, TRIG_SEL=0, TRIGGER_EN=false, UAB_PWR=0, VALID_WAVE=3, VDAC_EMPTY_MASK=false, WAVE_STEP_0=15121, WAVE_STEP_1=11778, WAVE_STEP_10=0, WAVE_STEP_11=0, WAVE_STEP_12=0, WAVE_STEP_13=0, WAVE_STEP_14=0, WAVE_STEP_15=0, WAVE_STEP_2=3590, WAVE_STEP_3=0, WAVE_STEP_4=0, WAVE_STEP_5=0, WAVE_STEP_6=0, WAVE_STEP_7=0, WAVE_STEP_8=0, WAVE_STEP_9=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UABPRIM_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_2:UAB, CY_INSTANCE_SHORT_NAME=UAB, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC_2_UAB, )
module UABPRIM_v1_10_4 (
    x0,
    vout,
    x1,
    x2,
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_2:OUTBUFFER, CY_INSTANCE_SHORT_NAME=OUTBUFFER, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC_2_OUTBUFFER, )
...
// UAB_VDAC_v1_10(ClockFrequency=250 kHz, DacGain=1, DacSelect=0, DefaultOutCode=0, DefaultOutVolts=1, ExtFeedback=false, ExtModBit=false, ExtStrobe=false, testParam_NoCTB=false, UserRefClkRate=250, UserRefClkRateEn=false, VagndSource=0, VagndVolts=1.2, VrefSource=0, VrefVolts=1.2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UAB_VDAC_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_2, CY_INSTANCE_SHORT_NAME=VDAC_2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC_2, )
module UAB_VDAC_v1_10_6 (
    vref,
    vo,
    vagnd,
    fb,
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_2, CY_INSTANCE_SHORT_NAME=PWM_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_2, )
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=true, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=true, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_2, CY_INSTANCE_SHORT_NAME=Timer_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer_2, )
...
module top ;
    ...
    Scan_ADC_v2_0_0 ADC_1 (
        ...
        .t_fvout(Net_380),
        .t_fvalid(Net_381),
        .t_fvinternal(Net_382[1:0]),
        .vagnd(Net_383),
        .vinPlus_0(Net_384),
        .vinPlus_1(Net_386));

    UAB_VDAC_v1_10_3 VDAC_1 (
        .vref(Net_133),
        .vo(Net_274),
        .vagnd(Net_135),
        .fb(Net_136),
	...
	wire [0:0] tmpOE__CPU_ANA_OUT2_net;
	wire [0:0] tmpFB_0__CPU_ANA_OUT2_net;
	wire [0:0] tmpIO_0__CPU_ANA_OUT2_net;
	wire [0:0] tmpINTERRUPT_0__CPU_ANA_OUT2_net;
	electrical [0:0] tmpSIOVREF__CPU_ANA_OUT2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		CPU_ANA_OUT2
		 (.oe(tmpOE__CPU_ANA_OUT2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CPU_ANA_OUT2_net[0:0]}),
		  .analog({Net_155}),
		  .io({tmpIO_0__CPU_ANA_OUT2_net[0:0]}),
		  .siovref(tmpSIOVREF__CPU_ANA_OUT2_net),
		  .interrupt({tmpINTERRUPT_0__CPU_ANA_OUT2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CPU_ANA_OUT2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CPU_ANA_OUT1_net;
	wire [0:0] tmpFB_0__CPU_ANA_OUT1_net;
	wire [0:0] tmpIO_0__CPU_ANA_OUT1_net;
	wire [0:0] tmpINTERRUPT_0__CPU_ANA_OUT1_net;
	electrical [0:0] tmpSIOVREF__CPU_ANA_OUT1_net;

	cy_psoc3_pins_v1_10
		#(.id("b23e8237-0337-409c-a272-d625f2b73210"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CPU_ANA_OUT1
		 (.oe(tmpOE__CPU_ANA_OUT1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CPU_ANA_OUT1_net[0:0]}),
		  .analog({Net_274}),
		  .io({tmpIO_0__CPU_ANA_OUT1_net[0:0]}),
		  .siovref(tmpSIOVREF__CPU_ANA_OUT1_net),
		  .interrupt({tmpINTERRUPT_0__CPU_ANA_OUT1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CPU_ANA_OUT1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CPU_ANA_IN1_net;
	wire [0:0] tmpFB_0__CPU_ANA_IN1_net;
	wire [0:0] tmpIO_0__CPU_ANA_IN1_net;
	wire [0:0] tmpINTERRUPT_0__CPU_ANA_IN1_net;
	electrical [0:0] tmpSIOVREF__CPU_ANA_IN1_net;

	cy_psoc3_pins_v1_10
		#(.id("1483c14c-f1aa-4c02-868b-09369c21a7c1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CPU_ANA_IN1
		 (.oe(tmpOE__CPU_ANA_IN1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CPU_ANA_IN1_net[0:0]}),
		  .analog({Net_384}),
		  .io({tmpIO_0__CPU_ANA_IN1_net[0:0]}),
		  .siovref(tmpSIOVREF__CPU_ANA_IN1_net),
		  .interrupt({tmpINTERRUPT_0__CPU_ANA_IN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CPU_ANA_IN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CPU_ANA_IN2_net;
	wire [0:0] tmpFB_0__CPU_ANA_IN2_net;
	wire [0:0] tmpIO_0__CPU_ANA_IN2_net;
	wire [0:0] tmpINTERRUPT_0__CPU_ANA_IN2_net;
	electrical [0:0] tmpSIOVREF__CPU_ANA_IN2_net;

	cy_psoc3_pins_v1_10
		#(.id("e655b24b-3dee-434b-9d4a-478d1a133d9e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CPU_ANA_IN2
		 (.oe(tmpOE__CPU_ANA_IN2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CPU_ANA_IN2_net[0:0]}),
		  .analog({Net_386}),
		  .io({tmpIO_0__CPU_ANA_IN2_net[0:0]}),
		  .siovref(tmpSIOVREF__CPU_ANA_IN2_net),
		  .interrupt({tmpINTERRUPT_0__CPU_ANA_IN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CPU_ANA_IN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_7 PWM_1 (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__CPU_FREQ_IN2_net;
	wire [0:0] tmpIO_0__CPU_FREQ_IN2_net;
	wire [0:0] tmpINTERRUPT_0__CPU_FREQ_IN2_net;
	electrical [0:0] tmpSIOVREF__CPU_FREQ_IN2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		CPU_FREQ_IN2
		 (.oe(tmpOE__CPU_FREQ_IN2_net),
		  .y({1'b0}),
		  .fb({Net_424}),
		  .io({tmpIO_0__CPU_FREQ_IN2_net[0:0]}),
		  .siovref(tmpSIOVREF__CPU_FREQ_IN2_net),
		  .interrupt({tmpINTERRUPT_0__CPU_FREQ_IN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CPU_FREQ_IN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CPU_FREQ_IN1_net;
	wire [0:0] tmpIO_0__CPU_FREQ_IN1_net;
	wire [0:0] tmpINTERRUPT_0__CPU_FREQ_IN1_net;
	electrical [0:0] tmpSIOVREF__CPU_FREQ_IN1_net;

	cy_psoc3_pins_v1_10
		#(.id("15ff6209-bf7f-45a2-a768-791ecb1cf79e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CPU_FREQ_IN1
		 (.oe(tmpOE__CPU_FREQ_IN1_net),
		  .y({1'b0}),
		  .fb({Net_417}),
		  .io({tmpIO_0__CPU_FREQ_IN1_net[0:0]}),
		  .siovref(tmpSIOVREF__CPU_FREQ_IN1_net),
		  .interrupt({tmpINTERRUPT_0__CPU_FREQ_IN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CPU_FREQ_IN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CPU_FREQ_OUT1_net;
	wire [0:0] tmpFB_0__CPU_FREQ_OUT1_net;
	wire [0:0] tmpIO_0__CPU_FREQ_OUT1_net;
	wire [0:0] tmpINTERRUPT_0__CPU_FREQ_OUT1_net;
	electrical [0:0] tmpSIOVREF__CPU_FREQ_OUT1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		CPU_FREQ_OUT1
		 (.oe(tmpOE__CPU_FREQ_OUT1_net),
		  .y({Net_447}),
		  .fb({tmpFB_0__CPU_FREQ_OUT1_net[0:0]}),
		  .io({tmpIO_0__CPU_FREQ_OUT1_net[0:0]}),
		  .siovref(tmpSIOVREF__CPU_FREQ_OUT1_net),
		  .interrupt({tmpINTERRUPT_0__CPU_FREQ_OUT1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CPU_FREQ_OUT1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CPU_FREQ_OUT2_net;
	wire [0:0] tmpFB_0__CPU_FREQ_OUT2_net;
	wire [0:0] tmpIO_0__CPU_FREQ_OUT2_net;
	wire [0:0] tmpINTERRUPT_0__CPU_FREQ_OUT2_net;
	electrical [0:0] tmpSIOVREF__CPU_FREQ_OUT2_net;

	cy_psoc3_pins_v1_10
		#(.id("bf25e472-98c0-4d23-a363-ddc4c928b007"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CPU_FREQ_OUT2
		 (.oe(tmpOE__CPU_FREQ_OUT2_net),
		  .y({Net_454}),
		  .fb({tmpFB_0__CPU_FREQ_OUT2_net[0:0]}),
		  .io({tmpIO_0__CPU_FREQ_OUT2_net[0:0]}),
		  .siovref(tmpSIOVREF__CPU_FREQ_OUT2_net),
		  .interrupt({tmpINTERRUPT_0__CPU_FREQ_OUT2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CPU_FREQ_OUT2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
