...
uint32 VDAC_2_UAB_initVar = 0UL; /**< 0 if component is uninitialized. 1 otherwise. */
...
/*! Part of default configuration used to initialize UAB in VDAC_2_UAB_Start() */
uint16 VDAC_2_UAB_waveConfig[VDAC_2_UAB_NUM_STEPS] = {
/*0<=last_step<=15 , so always at least one step*/
((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_0)

#if VDAC_2_UAB_INC_STEP_1
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_1)
#endif
#if VDAC_2_UAB_INC_STEP_2
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_2)
#endif
#if VDAC_2_UAB_INC_STEP_3
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_3)
#endif
#if VDAC_2_UAB_INC_STEP_4
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_4)
#endif
#if VDAC_2_UAB_INC_STEP_5
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_5)
#endif
#if VDAC_2_UAB_INC_STEP_6
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_6)
#endif
#if VDAC_2_UAB_INC_STEP_7
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_7)
#endif
#if VDAC_2_UAB_INC_STEP_8
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_8)
#endif
#if VDAC_2_UAB_INC_STEP_9
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_9)
#endif
#if VDAC_2_UAB_INC_STEP_10
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_10)
#endif
#if VDAC_2_UAB_INC_STEP_11
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_11)
#endif
#if VDAC_2_UAB_INC_STEP_12
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_12)
#endif
#if VDAC_2_UAB_INC_STEP_13
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_13)
#endif
#if VDAC_2_UAB_INC_STEP_14
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_14)
#endif
#if VDAC_2_UAB_INC_STEP_15
,((uint16)VDAC_2_UAB_PARAM_WAVE_STEP_15)
#endif
};

/*! Part of default configuration used to initialize UAB in VDAC_2_UAB_Start() */
CyUAB_reg_pair VDAC_2_UAB_initPairs[VDAC_2_UAB_INIT_PAIRS_COUNT] = {

	/*OA_CTRL default always first element in initPairs*/
#if VDAC_2_UAB_NONZERO_OA_CTRL
    {VDAC_2_UAB_OA_CTRL_PTR         , ((uint32)VDAC_2_UAB_DEFAULT_OA_CTRL)}
#endif
#if VDAC_2_UAB_NONZERO_SW_STATIC
    ,{VDAC_2_UAB_SW_STATIC_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_STATIC)}
#endif
#if VDAC_2_UAB_NONZERO_SW_MODBIT_SRC
    ,{VDAC_2_UAB_SW_MODBIT_SRC_PTR  , ((uint32)VDAC_2_UAB_DEFAULT_SW_MODBIT_SRC)}
#endif
#if VDAC_2_UAB_NONZERO_SRAM_CTRL
    ,{VDAC_2_UAB_SRAM_CTRL_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SRAM_CTRL)} 
#endif
...
#if VDAC_2_UAB_NONZERO_INTR_MASK	
    ,{VDAC_2_UAB_INTR_MASK_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_INTR_MASK)}
#endif
#if VDAC_2_UAB_NONZERO_CAP_CTRL
    ,{VDAC_2_UAB_CAP_CTRL_PTR       , ((uint32)VDAC_2_UAB_DEFAULT_CAP_CTRL)}
#endif
#if VDAC_2_UAB_NONZERO_CAP_ABCF_VAL
    ,{VDAC_2_UAB_CAP_ABCF_VAL_PTR   , ((uint32)VDAC_2_UAB_DEFAULT_CAP_ABCF_VAL)}
#endif
#if VDAC_2_UAB_NONZERO_CAP_AB_VAL_NXT
    ,{VDAC_2_UAB_CAP_AB_VAL_NXT_PTR , ((uint32)VDAC_2_UAB_DEFAULT_CAP_AB_VAL_NXT)}
#endif
#if VDAC_2_UAB_NONZERO_CAP_CF_VAL_NXT
    ,{VDAC_2_UAB_CAP_CF_VAL_NXT_PTR , ((uint32)VDAC_2_UAB_DEFAULT_CAP_CF_VAL_NXT)}
#endif
#if VDAC_2_UAB_NONZERO_STARTUP_DELAY
    ,{VDAC_2_UAB_STARTUP_DELAY_PTR  , ((uint32)VDAC_2_UAB_DEFAULT_STARTUP_DELAY)}
#endif
#if VDAC_2_UAB_NONZERO_SUBSAMPLE_CTRL
    ,{VDAC_2_UAB_SUBSAMPLE_CTRL_PTR , ((uint32)VDAC_2_UAB_DEFAULT_SUBSAMPLE_CTRL)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CA_IN0
    ,{VDAC_2_UAB_SW_CA_IN0_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CA_IN0)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CA_IN1
    ,{VDAC_2_UAB_SW_CA_IN1_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CA_IN1)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CA_TOP
    ,{VDAC_2_UAB_SW_CA_TOP_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CA_TOP)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CB_IN0
    ,{VDAC_2_UAB_SW_CB_IN0_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CB_IN0)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CB_IN1
    ,{VDAC_2_UAB_SW_CB_IN1_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CB_IN1)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CB_TOP
    ,{VDAC_2_UAB_SW_CB_TOP_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CB_TOP)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CC_IN0
    ,{VDAC_2_UAB_SW_CC_IN0_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CC_IN0)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CC_IN1
    ,{VDAC_2_UAB_SW_CC_IN1_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CC_IN1)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CC_TOP
    ,{VDAC_2_UAB_SW_CC_TOP_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CC_TOP)}
#endif
#if VDAC_2_UAB_NONZERO_SW_CF_BOT
    ,{VDAC_2_UAB_SW_CF_BOT_PTR      , ((uint32)VDAC_2_UAB_DEFAULT_SW_CF_BOT)}
#endif
#if VDAC_2_UAB_NONZERO_SW_OTHER
    ,{VDAC_2_UAB_SW_OTHER_PTR       , ((uint32)VDAC_2_UAB_DEFAULT_SW_OTHER)}
#endif
#if VDAC_2_UAB_NONZERO_SW_BOOST_CTRL
    ,{VDAC_2_UAB_SW_BOOST_CTRL_PTR  , ((uint32)VDAC_2_UAB_DEFAULT_SW_BOOST_CTRL)}
#endif


};

/*! Default configuration used to initialize UAB in VDAC_2_UAB_Start() */
CyUAB_config VDAC_2_UAB_config = {
    VDAC_2_UAB_waveConfig,
    VDAC_2_UAB_initPairs,
    CyUAB_SHARED_SW_CFG(VDAC_2_UAB_PARAM_REF_TIED,VDAC_2_UAB_PARAM_AGND_TIED,
        VDAC_2_UAB_PARAM_SW_CC,VDAC_2_UAB_PARAM_SW_BB,VDAC_2_UAB_PARAM_SW_AA),
    VDAC_2_UAB_NUM_STEPS,
    (uint8)(VDAC_2_UAB_ELEMENT_COUNT(VDAC_2_UAB_initPairs))
};
...
* VDAC_2_UAB_Enable(), VDAC_2_UAB_Init(&VDAC_2_UAB_config), and VDAC_2_UAB_Run(1UL).  
...
*
* \globalvars
*  \ref VDAC_2_UAB_initVar (RW)
*
*******************************************************************************/
void VDAC_2_UAB_Start(void)
{
    if (VDAC_2_UAB_initVar != 1UL)
    {
        VDAC_2_UAB_Init(&VDAC_2_UAB_config);
        VDAC_2_UAB_initVar = 1UL;
    }
    else 
    {
    ...
    VDAC_2_UAB_Run(1UL); /*set the run bit*/
}
...
* @endinternal
* 
* @see VDAC_2_UAB_Start()
* @see VDAC_2_UAB_Run()
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_Stop(void)
{
    VDAC_2_UAB_Run(0UL); /*Clear run bit*/
    /*Intentionally not clearing the enable bit because it has a side-effect - 
	the enable bit is shared with another UAB half*/
}


/* Support function for VDAC_2_UAB_Init() */
void VDAC_2_UAB_WriteInitPairs(const CyUAB_reg_pair pairs[], size_t n)
{
    uint32 i;
    for( i = 0UL; i < n; i++ )
    {
...
* @sideeffect Sets ENABLED bit for whole UAB - both half0 and half1.
*******************************************************************************/
void VDAC_2_UAB_Init(const CyUAB_config * cfg)
{
#if VDAC_2_UAB_ISPAIRED 
    ...
    CyUAB_SetNSteps( VDAC_2_UAB_SRAM0_PTR, ((size_t)(cfg->stepCount)), (cfg->waveSteps) );
    
    /* Optimized version of ClearAllClocks() -- 
    Clear remaining wavesteps, so clock editing with SetClock() works
    */
    (void)CyUAB_wordset( 
        ((reg32*)( ((uint32)(VDAC_2_UAB_SRAM0_PTR)) + (((uint32)(cfg->stepCount))*sizeof(uint32)) )), 
        0UL, 
        ( ( CyUAB_STEPS_LEN_MAX - ((uint32)(cfg->stepCount)) ) * sizeof(uint32) )
    );
    
    VDAC_2_UAB_WriteInitPairs( cfg->pairs, ((size_t)(cfg->pairCount)) );
    /* ^ 
    *  | 
    *  | 
...
* How to disable:
* VDAC_2_UAB_UAB_CTRL_REG &= ~VDAC_2_UAB_ENABLED_MASK;
*
...
* @see VDAC_2_UAB_Start()
* @see VDAC_2_UAB_Init()
* @see VDAC_2_UAB_SetUABPower()
* @see VDAC_2_UAB_SetOAPower()
* @see VDAC_2_UAB_SetCompPower()
* @see VDAC_2_UAB_SetRefPower()
* @see VDAC_2_UAB_SetAgndPower()
* 
* @sideeffect Sets ENABLED bit for whole UAB - both half0 and half1.
*******************************************************************************/
void VDAC_2_UAB_Enable(void)
{
    VDAC_2_UAB_UAB_CTRL_REG |= VDAC_2_UAB_ENABLED_MASK; /*Side effect: also enables other UAB half in same pair*/
}
...
*
* @internal
* @reglist @reg VDAC_2_UAB_INTR_REG
* @endinternal
* 
* @see VDAC_2_UAB_SetInterrupt()
* 
* @see VDAC_2_UAB_SetInterruptMask()
* @see VDAC_2_UAB_ClearInterruptMask()
* @see VDAC_2_UAB_GetInterruptIsMasked()
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_ClearInterrupt(CyUAB_intr_enum intr)
{
    ...
    uint32 mask = ( (CyUAB_INTR_COMP==intr)      ? ((uint32)VDAC_2_UAB_INTR_COMP_MASK) : 
                  ( (CyUAB_INTR_VDAC_EMPTY==intr)? ((uint32)VDAC_2_UAB_INTR_VDAC_EMPTY_MASK) : 
                  0UL ) );
    if(0UL!=mask)
    {
        *(VDAC_2_UAB_INTR_PTR) |= mask;    
    }
}

/************* VDAC_2_UAB_SetInterrupt() ********************************/
/*!
...
*
* @internal
* @reglist @reg VDAC_2_UAB_INTR_SET_REG
* @endinternal
*
* 
* @see VDAC_2_UAB_ClearInterrupt()
* @see VDAC_2_UAB_SetInterruptMask()
* @see VDAC_2_UAB_ClearInterruptMask()
* @see VDAC_2_UAB_GetInterruptIsMasked()
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetInterrupt(CyUAB_intr_enum intr)
{
    ...
    if(0UL!=mask)
    {
        *(VDAC_2_UAB_INTR_SET_PTR) |= mask;
    }
}

/************** VDAC_2_UAB_SetInterruptMask() ***************************/
/*!
...
*
* @internal
* @reglist @reg VDAC_2_UAB_INTR_MASK_REG
* @endinternal
* 
* @see VDAC_2_UAB_SetInterrupt()
* @see VDAC_2_UAB_ClearInterrupt()
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetInterruptMask(CyUAB_intr_enum intr)
{
    ...
    if(0UL!=mask)
    {
        *(VDAC_2_UAB_INTR_MASK_PTR) |= mask;    
    }
}

/************* VDAC_2_UAB_ClearInterruptMask() **************************/
/*!
...
* @sideeffect None
******************************************************************************/
void VDAC_2_UAB_ClearInterruptMask(CyUAB_intr_enum intr)
{
...
/********** VDAC_2_UAB_GetInterruptIsMasked() ***************************/
/*!
...
*
* @internal
* @reglist VDAC_2_UAB_INTR_MASKED_REG
* @endinternal
*
* @see VDAC_2_UAB_SetInterrupt()
* @see VDAC_2_UAB_ClearInterrupt()
...
* @sideeffect None
*******************************************************************************/
uint32 VDAC_2_UAB_GetInterruptIsMasked(CyUAB_intr_enum intr)
{
    ...
    r = ( 0UL != ( (*(VDAC_2_UAB_INTR_MASKED_PTR)) & mask ) ) ? 1UL : 0UL;
    return r;
}

/*Power*/

/***************** VDAC_2_UAB_SetUABPower() *****************************/
/*!
...
* 
* @internal
* @reglist @reg VDAC_2_UAB_OA0_CTRL @reg VDAC_2_UAB_OA1_CTRL
* @endinternal
* 
* @see VDAC_2_UAB_Stop()
* @see VDAC_2_UAB_SetOAPower()
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetUABPower(CyUAB_coarse_pwr_enum powerLevel)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_UAB_PWR_MASK, 
      ((uint32)powerLevel), 
      VDAC_2_UAB_UAB_PWR_SHIFT
    );
}


/************* VDAC_2_UAB_SetOAPower() **********************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetOAPower(CyUAB_fine_pwr_enum powerLevel)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_OA_PWR_MASK, 
      ((uint32)powerLevel), 
      VDAC_2_UAB_OA_PWR_SHIFT
    );
}


/******************** VDAC_2_UAB_SetCompPower() *************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetCompPower(CyUAB_fine_pwr_enum powerLevel)
{  
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_CMP_PWR_MASK, 
      ((uint32)powerLevel), 
      VDAC_2_UAB_CMP_PWR_SHIFT
    );
}


/***************** VDAC_2_UAB_SetRefPower *******************************/
/*!
...
* VDAC_2_UAB_NET_REF signal--relative to the power mode of the UAB. Returns @c void.
* 
* @internal
* @reglist @reg VDAC_2_UAB_OA0_CTRL @reg VDAC_2_UAB_OA1_CTRL
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetRefPower(CyUAB_fine_pwr_enum powerLevel)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_REF_PWR_MASK, 
      ((uint32)powerLevel), 
      VDAC_2_UAB_REF_PWR_SHIFT
    );
}


/**************** VDAC_2_UAB_SetAgndPower() *****************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetAgndPower(CyUAB_fine_pwr_enum powerLevel)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_AGND_PWR_MASK, 
      ((uint32)powerLevel), 
      VDAC_2_UAB_AGND_PWR_SHIFT
    );
}


/**************** VDAC_2_UAB_SetRefVdda() *******************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetRefVdda(CyUAB_ref_force_vdda_enum forceVdda)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_REF_PTS_MASK, 
      ((uint32)forceVdda), 
      VDAC_2_UAB_REF_PTS_SHIFT
    );
}


/*************** VDAC_2_UAB_SetAgndVdda() *******************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetAgndVdda(CyUAB_agnd_force_vdda_enum forceVdda)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_AGND_PTS_MASK, 
      ((uint32)forceVdda), 
      VDAC_2_UAB_AGND_PTS_SHIFT
    );
}


/************* VDAC_2_UAB_SetRefTied() **********************************/
/*!
...
*
* @internal
* @reglist @reg VDAC_2_UAB_OA1_CTRL
* @image html _.png 
* @endinternal
* 
* 
* @see VDAC_2_UAB_SetAgndTied()
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetRefTied( CyUAB_ref_tied_enum refTied)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_REF_TIED_PTR, 
      VDAC_2_UAB_REF_TIED_MASK, 
      ((uint32)refTied), 
      VDAC_2_UAB_REF_TIED_SHIFT
    );
}

/*********** VDAC_2_UAB_SetAgndTied() ***********************************/
/*!
...
* 
* @internal
* @reglist @reg VDAC_2_UAB_OA0_CTRL
* @image html _.png 
* @endinternal
* 
* @see VDAC_2_UAB_SetRefTied()
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetAgndTied(CyUAB_agnd_tied_enum agndTied)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_AGND_TIED_PTR, 
      VDAC_2_UAB_AGND_TIED_MASK, 
      ((uint32)agndTied), 
      VDAC_2_UAB_AGND_TIED_SHIFT
    );
}
...
* @see VDAC_2_UAB_SetAttenBypassSwitchB()
* @see VDAC_2_UAB_SetAttenBypassSwitchC()
*
* @see VDAC_2_UAB_SetCaps()
* @see VDAC_2_UAB_SetCapB()
* @see VDAC_2_UAB_SetCapC()
* @see VDAC_2_UAB_SetCapF()
*
* @internal
* @reglist @reg VDAC_2_UAB_CAP_ABCF0_VAL @reg VDAC_2_UAB_CAP_ABCF1_VAL
* @image html SetCapacitors.png 
* @endinternal
*
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetCapA(CyUAB_cap_enum capA)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_ABCF_VAL_PTR,
      VDAC_2_UAB_CA_VAL_MASK, 
      ((uint32)capA), 
      VDAC_2_UAB_CA_VAL_SHIFT
    );
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_AB_VAL_NXT_PTR, 
      VDAC_2_UAB_CA_VAL_MASK, 
      ((uint32)capA), 
      VDAC_2_UAB_CA_VAL_SHIFT
    ); 
...
*
* @see VDAC_2_UAB_SetCaps()
* @see VDAC_2_UAB_SetCapA()
* @see VDAC_2_UAB_SetCapC()
* @see VDAC_2_UAB_SetCapF()
* @see VDAC_2_UAB_SetGroundUnused()
*
* @internal
* @reglist @reg VDAC_2_UAB_CAP_ABCF0_VAL @reg VDAC_2_UAB_CAP_ABCF1_VAL
* @image html SetCapacitors.png 
...
*******************************************************************************/
void VDAC_2_UAB_SetCapB(CyUAB_b_cap_enum capB)
{
    const uint32 threshold64 = 64UL; /*capB>=64 are treated the same (set CB_64 and CB_VAL[5:0]==0x3F) */
    const uint32 b64 = VDAC_2_UAB_CB_64_MASK | VDAC_2_UAB_CB_VAL_MASK;
    uint32 bval = (((uint32)capB)>=threshold64) ? b64 : ((uint32)capB);
    VDAC_2_UAB_SET_VARIOUS_FIELDS(
      VDAC_2_UAB_CAP_ABCF_VAL_PTR,
      VDAC_2_UAB_CB_64_MASK | VDAC_2_UAB_CB_VAL_MASK, 
       bval
    );
    ...
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_AB_VAL_NXT_PTR, 
      VDAC_2_UAB_CB_VAL_MASK, 
      bval,
      VDAC_2_UAB_CB_VAL_SHIFT
    );
}
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetCapC(CyUAB_cap_enum capC)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_ABCF_VAL_PTR,
      VDAC_2_UAB_CC_VAL_MASK, 
      ((uint32)capC), 
      VDAC_2_UAB_CC_VAL_SHIFT
    );
    /*Not setting CC_VAL_UPDATE bit*/
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_CF_VAL_NXT_PTR, 
      VDAC_2_UAB_CC_VAL_MASK, 
      ((uint32)capC), 
      VDAC_2_UAB_CC_VAL_SHIFT
    );
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetCapF(CyUAB_f_cap_enum capF)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_ABCF_VAL_PTR,
      VDAC_2_UAB_CF_VAL_MASK, 
      ((uint32)capF), 
      VDAC_2_UAB_CF_VAL_SHIFT
    );
...
* @note In branches B and C, there are attenuation capacitors in the signal path.
* This function does not configure those capacitors.  See VDAC_2_UAB_SetAttenuationTrim() 
* and VDAC_2_UAB_SetAttenBypassSwitch().
* 
...
* @see VDAC_2_UAB_SetCapF()
* @see VDAC_2_UAB_SetGroundUnused()
* @see VDAC_2_UAB_SetSwitch(CyUAB_SW_TB,clk)
* @see VDAC_2_UAB_SetSwitch(CyUAB_SW_TC,clk)
* 
* @internal
* @reglist @reg VDAC_2_UAB_CAP_ABCF0_VAL @reg VDAC_2_UAB_CAP_ABCF1_VAL
* @image html _.png 
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetCaps(CyUAB_cap_enum capA, CyUAB_b_cap_enum capB, 
    CyUAB_cap_enum capC, CyUAB_f_cap_enum capF)
{
    VDAC_2_UAB_SetCapA(capA);
    VDAC_2_UAB_SetCapB(capB);
    VDAC_2_UAB_SetCapC(capC);
    VDAC_2_UAB_SetCapF(capF);
}

/********* VDAC_2_UAB_SetGroundUnused() *********************************/
/*!
...
*
* @internal
* @reglist @reg VDAC_2_UAB_CAP_CTRL0 VDAC_2_UAB_CAP_CTRL1
* @image html SetCapacitors.png 
* @endinternal
*
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetGroundUnused(CyUAB_gnd_unused_enum gndUnusedB, CyUAB_gnd_unused_enum gndUnusedC )
{
    
    /*mask input values before shifting to prevent overlap*/
    const uint32 CB_GND_PRESHIFT_MASK = VDAC_2_UAB_CB_GND_MASK>>VDAC_2_UAB_CB_GND_SHIFT;
    const uint32 CC_GND_PRESHIFT_MASK = VDAC_2_UAB_CC_GND_MASK>>VDAC_2_UAB_CC_GND_SHIFT;
    const uint32 mask = VDAC_2_UAB_CC_GND_MASK | VDAC_2_UAB_CB_GND_MASK;
    VDAC_2_UAB_SET_VARIOUS_FIELDS(
      VDAC_2_UAB_CAP_CTRL_PTR,
      mask,
      ((uint32)( 
        ( ( ((uint32)gndUnusedC) & CC_GND_PRESHIFT_MASK) <<VDAC_2_UAB_CC_GND_SHIFT ) |
        ( ( ((uint32)gndUnusedB) & CB_GND_PRESHIFT_MASK) <<VDAC_2_UAB_CB_GND_SHIFT )
      ))
    );
}
...
*
* @see VDAC_2_UAB_SetDacMode()
* @see VDAC_2_UAB_SetModbitSource()
*
* @internal
* @reglist @reg VDAC_2_UAB_CAP_CTRL_REG
* @endinternal
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetDacModeEn(CyUAB_dac_mode_en_enum isEnabled)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_CTRL_PTR, 
      VDAC_2_UAB_DAC_MODE_EN_MASK, 
      ((uint32)isEnabled), 
      VDAC_2_UAB_DAC_MODE_EN_SHIFT
    );
}

/*************** VDAC_2_UAB_SetDacMode() ********************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetDacMode(CyUAB_dac_mode_enum dacMode)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_CTRL_PTR, 
      VDAC_2_UAB_DAC_MODE_MASK, 
      ((uint32)dacMode), 
      VDAC_2_UAB_DAC_MODE_SHIFT
    );    
}

/*************** VDAC_2_UAB_SetDacNext() ********************************/
/*!
...
*
* @internal
* @reglist @reg VDAC_2_UAB_CAP_AB_VAL_NXT_REG.
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetDacNext(int16 nextDACVal)
{
    ...
    uint32 val = ( ((uint32)nextDACVal) & ((uint32)VDAC_2_UAB_DAC_NEXT_MASK) );
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_AB_VAL_NXT_PTR, 
      VDAC_2_UAB_DAC_NEXT_MASK, 
      val, 
      VDAC_2_UAB_CB_VAL_SHIFT
    );
}
...
*
* @internal
* @reglist @reg VDAC_2_UAB_CAP_CF_VAL_NXT_REG.
* This function is @b NOT generalized.  It depends on the 'next' values all
* being contiguous within a single register.
* @endinternal
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetCapCFNext(CyUAB_cap_enum nextCapC,CyUAB_f_cap_enum nextCapF)
{
    const uint32 CF_VAL_PRESHIFT_MASK = ((uint32)(VDAC_2_UAB_CF_VAL_MASK>>VDAC_2_UAB_CF_VAL_SHIFT));
    const uint32 CC_VAL_PRESHIFT_MASK = ((uint32)(VDAC_2_UAB_CC_VAL_MASK>>VDAC_2_UAB_CC_VAL_SHIFT));
    const uint32 mask = ((uint32)VDAC_2_UAB_CF_VAL_UPDATE_MASK) | ((uint32)VDAC_2_UAB_CC_VAL_UPDATE_MASK) |
      ((uint32)VDAC_2_UAB_CF_VAL_MASK) | ((uint32)VDAC_2_UAB_CC_VAL_MASK);
    
    /* Also setting CF_VAL_UPDATE and CC_VAL_UPDATE bits */
    VDAC_2_UAB_SET_VARIOUS_FIELDS(
      VDAC_2_UAB_CAP_CF_VAL_NXT_PTR,
      mask,
      ((uint32)VDAC_2_UAB_CF_VAL_UPDATE_MASK) | ((uint32)VDAC_2_UAB_CC_VAL_UPDATE_MASK) |
        ( ( ((uint32)nextCapF) & CF_VAL_PRESHIFT_MASK)<<VDAC_2_UAB_CF_VAL_SHIFT ) |
        ( ( ((uint32)nextCapC) & CC_VAL_PRESHIFT_MASK)<<VDAC_2_UAB_CC_VAL_SHIFT ) 
	);
}
...
*
* @internal
* @reglist @reg VDAC_2_UAB_OA0_CTRL_REG VDAC_2_UAB_OA1_CTRL_REG
* @endinternal
* 
* 
* @see VDAC_2_UAB_SetCompOutLevel()
* @see VDAC_2_UAB_GetCompStatus()
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetCompEdgeDetect(CyUAB_cmp_edge_enum detectMode)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_CMP_EDGE_MASK, 
      ((uint32)detectMode), 
      VDAC_2_UAB_CMP_EDGE_SHIFT
    );
}

/************ VDAC_2_UAB_SetCompOutLevel ********************************/
/*!
...
* 
* @internal
* @reglist @reg VDAC_2_UAB_OA0_CTRL_REG
* @endinternal
* 
* @param isLevel
...
*
* @see VDAC_2_UAB_SetCompEdgeDetect()
* 
* @see VDAC_2_UAB_GetCompStatus()
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetCompOutLevel(CyUAB_cmp_level_enum isLevel)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_OA_CTRL_PTR, 
      VDAC_2_UAB_CMP_DSI_LEVEL_MASK, 
      ((uint32)isLevel), 
      VDAC_2_UAB_CMP_DSI_LEVEL_SHIFT
    );
}


/************  VDAC_2_UAB_GetCompStatus() *******************************/
/*!
...
* @sideeffect None
*******************************************************************************/
uint32 VDAC_2_UAB_GetCompStatus(void)
{
    /*GET_FIELD() has an addional shift*/
    uint32 r = (0UL != ((*(VDAC_2_UAB_STAT_PTR)) & VDAC_2_UAB_COMP_MASK)) ? 1UL : 0UL;
    return r;    
}
...
*
* @internal
* @reglist @reg VDAC_2_UAB_SW_STATIC0_REG or VDAC_2_UAB_SW_STATIC1_REG
* @image html _.png 
* @endinternal
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetEarly(CyUAB_sw_id_enum sw_id, CyUAB_clk_adj_enum isEarly)
{
    if( CyUAB_SW_PS==sw_id )
    {
        VDAC_2_UAB_SET_FIELD(
          VDAC_2_UAB_SW_STATIC_PTR, 
          VDAC_2_UAB_EARLY_PS_MASK, 
          ((uint32)isEarly), 
          VDAC_2_UAB_EARLY_PS_SHIFT
        ); 
    }
    else if( CyUAB_SW_PO==sw_id )
    {
        VDAC_2_UAB_SET_FIELD(
          VDAC_2_UAB_SW_STATIC_PTR, 
          VDAC_2_UAB_EARLY_PO_MASK, 
          ((uint32)isEarly), 
          VDAC_2_UAB_EARLY_PO_SHIFT
        );
    }
    else
    {
...
* they will either wait for a trigger (see VDAC_2_UAB_SetInputTrigger()),
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_Run(uint32 flag)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_SRAM_CTRL_PTR,
      VDAC_2_UAB_RUN_MASK, 
      flag, 
      VDAC_2_UAB_RUN_SHIFT
    );    
}


/************** VDAC_2_UAB_SetLastStep() ********************************/
/*!
...
* 
* @internal
* @reglist @reg VDAC_2_UAB_SRAM0_CTRL_REG
* @endinternal
* 
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetLastStep(uint32 lastStep)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_SRAM_CTRL_PTR, 
      VDAC_2_UAB_LAST_STEP_MASK,
      lastStep, 
      VDAC_2_UAB_LAST_STEP_SHIFT
    );    
}

/******** VDAC_2_UAB_SetStartupDelay() **********************************/
/*!
...
* 
* @internal
* @reglist @reg VDAC_2_UAB_STARTUP_DELAY0_REG
* @endinternal
* 
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetStartupDelay(uint16 delayCount)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_STARTUP_DELAY_PTR, 
      VDAC_2_UAB_STARTUP_DELAY_MASK, 
      (uint32)delayCount, 
      VDAC_2_UAB_STARTUP_DELAY_SHIFT
    );
}

/*********** VDAC_2_UAB_SetAlignMode() **********************************/
/*!
...
*
* @internal
* @reglist @reg VDAC_2_UAB_STARTUP_DELAY0_REG , VDAC_2_UAB_STARTUP_DELAY1_REG
* @endinternal
*
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetAlignMode(CyUAB_align_mode_enum alignMode)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_STARTUP_DELAY_PTR, 
      VDAC_2_UAB_ALIGN_MODE_MASK, 
      ((uint32)alignMode), 
      VDAC_2_UAB_ALIGN_MODE_SHIFT
    );
}


/******** VDAC_2_UAB_SetSubsample() *************************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetSubsample(uint8 subsample)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_SUBSAMPLE_CTRL_PTR, 
      VDAC_2_UAB_SUBSAMPLE_MASK, 
      ((uint32)subsample), 
      VDAC_2_UAB_SUBSAMPLE_SHIFT
    );
}

/***************  VDAC_2_UAB_SetSubsampleInit() *************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetSubsampleInit(uint8 subsampleInit)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_SUBSAMPLE_CTRL_PTR, 
      VDAC_2_UAB_SUBSAMPLE_INIT_MASK, 
      ((uint32)subsampleInit), 
      VDAC_2_UAB_SUBSAMPLE_INIT_SHIFT
    );
}


/************* VDAC_2_UAB_GetCurrentSubsample() *************************/
/*!
...
* @sideeffect None
*******************************************************************************/
uint32 VDAC_2_UAB_GetCurrentSubsample(void)
{
    return VDAC_2_UAB_GET_FIELD(
      VDAC_2_UAB_STAT_PTR,
      VDAC_2_UAB_CURR_SUBSAMPLE_MASK,
      VDAC_2_UAB_CURR_SUBSAMPLE_SHIFT
    );
}

/************** VDAC_2_UAB_GetCurrentStep() *****************************/
/*!
* @brief Get currStep
* 
* @details
...
* @sideeffect None
*******************************************************************************/
uint32 VDAC_2_UAB_GetCurrentStep(void)
{
    return VDAC_2_UAB_GET_FIELD(
      VDAC_2_UAB_STAT_PTR,
      VDAC_2_UAB_CURR_STEP_MASK,
      VDAC_2_UAB_CURR_STEP_SHIFT
    );
}


/**************** VDAC_2_UAB_SetModbitSource() **************************/
/*!
...
* 
* @internal
* @reglist @reg VDAC_2_UAB_SW_MODBIT_SRC0 , VDAC_2_UAB_SW_MODBIT_SRC1
* @endinternal
* 
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetModbitSource( uint32 modbitSrcAB, uint32 modbitSrcC )
{
    /*mask input values before shifting to prevent overlap*/
    const uint32 MODBIT_SRC_AB_PRESHIFT_MASK = VDAC_2_UAB_MODBIT0_SRC_SEL_MASK>>VDAC_2_UAB_MODBIT0_SRC_SEL_SHIFT;
    const uint32 MODBIT_SRC_C_PRESHIFT_MASK = VDAC_2_UAB_MODBIT1_SRC_SEL_MASK>>VDAC_2_UAB_MODBIT1_SRC_SEL_SHIFT;
    VDAC_2_UAB_SET_VARIOUS_FIELDS(
      VDAC_2_UAB_SW_MODBIT_SRC_PTR,
      VDAC_2_UAB_MODBIT1_SRC_SEL_MASK | VDAC_2_UAB_MODBIT0_SRC_SEL_MASK,
      (uint32)( 
        ( (modbitSrcAB & MODBIT_SRC_AB_PRESHIFT_MASK) <<VDAC_2_UAB_MODBIT0_SRC_SEL_SHIFT ) | 
        ( (modbitSrcC &MODBIT_SRC_C_PRESHIFT_MASK) <<VDAC_2_UAB_MODBIT1_SRC_SEL_SHIFT ) 
      )
    );    
}


/********************** VDAC_2_UAB_SetStrobeMode ************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetStrobeMode(CyUAB_strobe_mode_enum strobeMode)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_SW_STATIC_PTR, 
      VDAC_2_UAB_STRB_RST_EN_MASK, 
      ((uint32)strobeMode), 
      VDAC_2_UAB_STRB_RST_EN_SHIFT
    );
}

/*********** VDAC_2_UAB_SetStrobeSource *********************************/
/*!
...
@internal
@reglist @reg VDAC_2_UAB_SW_STATIC0_REG.STRB_RST0_SEL or VDAC_2_UAB_SW_STATIC1_REG.STRB_RST1_SEL
@endinternal
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetStrobeSource(uint32 strobeSource)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_SW_STATIC_PTR, 
      VDAC_2_UAB_STRB_RST_SEL_MASK, 
      strobeSource, 
      VDAC_2_UAB_STRB_RST_SEL_SHIFT
    );
}


/************ VDAC_2_UAB_SetFirmwareModbit() ****************************/
/*!
* @brief Set the firmware modbit.
* 
* @details This function sets the firmware modbit. The modbit affects several 
* clocks.  If firmware modbit is selected (Use VDAC_2_UAB_SetModbitSource() choice 31),
...
* DAC.
*******************************************************************************/
void VDAC_2_UAB_SetFirmwareModbit(uint32 flag)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_CAP_ABCF_VAL_PTR, 
      VDAC_2_UAB_SIGN_VAL_MASK,
      (uint32)flag, 
      VDAC_2_UAB_SIGN_VAL_SHIFT
    );
}


/************* VDAC_2_UAB_SetInputTrigger() *****************************/
/*!
...
* which trigger to use.  Trigger state is irrelevant if VDAC_2_UAB_EnableClocks()
* has not been called.
* 
* @internal
* @reglist @reg VDAC_2_UAB_SRAM0_CTRL_REG VDAC_2_UAB_SRAM1_CTRL_REG
* @endinternal
* 
* @param triggerEn Enables the input trigger.  If 0, trigger signal is ignored,
* and the SRAM clocks will start running as soon as the VDAC_2_UAB_EnableClocks()
...
* For PSoC4400, only values 0-1, 8-13, and 31 are valid.
*
* @see VDAC_2_UAB_EnableClocks()
* 
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetInputTrigger(uint32 triggerEn, uint32 triggerSel)
{
    /*mask input values before shifting to prevent overlap*/
    const uint32 TRIG_SEL_PRESHIFT_MASK = VDAC_2_UAB_TRIG_SEL_MASK>>VDAC_2_UAB_TRIG_SEL_SHIFT;
    const uint32 TRIGGER_EN_PRESHIFT_MASK = VDAC_2_UAB_TRIGGER_EN_MASK>>VDAC_2_UAB_TRIGGER_EN_SHIFT;
    VDAC_2_UAB_SET_VARIOUS_FIELDS(
      VDAC_2_UAB_SRAM_CTRL_PTR,
      VDAC_2_UAB_TRIG_SEL_MASK | VDAC_2_UAB_TRIGGER_EN_MASK,
      ( (triggerSel & TRIG_SEL_PRESHIFT_MASK) <<VDAC_2_UAB_TRIG_SEL_SHIFT   ) | 
      ( (triggerEn & TRIGGER_EN_PRESHIFT_MASK) <<VDAC_2_UAB_TRIGGER_EN_SHIFT )
    );
}


/****************** VDAC_2_UAB_SetStaticSwitch() ************************/
/*!
...
* @sideeffect None
*******************************************************************************/
void VDAC_2_UAB_SetStaticSwitch(CyUAB_sw_id_enum sw_id, CyUAB_clk_enum clk)
{   
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_GetStaticSwAddr( (sw_id) ), 
      VDAC_2_UAB_StaticSwMask( (sw_id) ),
      CyUAB_SwIsClosed( (clk) ), 
      VDAC_2_UAB_StaticSwShift( (sw_id) )
    );
}


/******************** VDAC_2_UAB_SetSwitch() ****************************/
/*!
...
* @sideeffect None
*//*==========================================================================*/
void VDAC_2_UAB_SetSwitch(CyUAB_sw_id_enum sw_id, CyUAB_clk_enum clk)
{
    VDAC_2_UAB_SET_FIELD(
      VDAC_2_UAB_GetDynamicSwAddr( (sw_id) ),
      VDAC_2_UAB_DynamicSwMask( (sw_id) ),
      ((uint32)((clk))), 
      VDAC_2_UAB_DynamicSwShift( (sw_id) )
    ); 
}
